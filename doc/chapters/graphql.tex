...
% % Kress 46
% \parencite[S. 46]{kress2020graphql}
...
\section{1 + n Problem}
Das klassische Beispiel für Probleme mit Bezug auf die Performanz in GraphQL ist das \glqq1 + n Problem\grqq{}.
...
% Der DataLoader generiert bei jeder Anfrage auf den GraphQL-Endpunkt eine Liste an Schlüssel-Wert-Paaren und löst die Anfragen darin auf \parencite[S. 105]{kress2020graphql}.
